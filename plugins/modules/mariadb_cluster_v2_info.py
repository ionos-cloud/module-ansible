...
STATES = ['info']
OBJECT_NAME = 'MariaDB Clusters (v2)'
...
DOCUMENTATION = """
module: mariadb_cluster_v2_info
short_description: List MariaDB Clusters (DBaaS MariaDB v2 API)
description:
     - This is a simple module that supports listing existing MariaDB Clusters using the
       DBaaS MariaDB v2 API. The region is selected through the I(location) option;
       set I(api_url) (e.g. C(https://mariadb.de-fra.ionos.com/v2)) to override it directly.
version_added: "2.0"
options:
    api_url:
        description:
...
def get_objects(module, client):
    return get_paginated(ionoscloud_dbaas_mariadb.ClustersApi(client).clusters_get, depth=None)
