...
STATES = ['info']
OBJECT_NAME = 'MariaDB Versions (v2)'
RETURNED_KEY = 'mariadb_versions'
...
DOCUMENTATION = """
module: mariadb_version_v2_info
short_description: List MariaDB Versions (DBaaS MariaDB v2 API)
description:
     - This is a simple module that supports listing the MariaDB versions available for
       clusters, using the DBaaS MariaDB v2 API. The region is selected through the
       I(location) option; set I(api_url) (e.g. C(https://mariadb.de-fra.ionos.com/v2)) to override it directly.
version_added: "2.0"
options:
    api_url:
        description:
...
def get_objects(module, client):
    return get_paginated(ionoscloud_dbaas_mariadb.VersionsApi(client).versions_get, depth=None)
