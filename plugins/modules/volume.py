...
def _update_volume(module, volume_server, api_client, datacenter, volume_id):
    ...
    try:
        volume_properties = VolumeProperties(size=size, availability_zone=availability_zone, bus=bus,
