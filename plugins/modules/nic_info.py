...
def get_objects(module, client):
    ...
    nics = nics_api.datacenters_servers_nics_get(datacenter_id, server_id, depth=module.params.get('depth'))

    try:
        results = list(map(lambda x: x.to_dict(), apply_filters(module, nics.items)))
        return {
            'changed': False,
