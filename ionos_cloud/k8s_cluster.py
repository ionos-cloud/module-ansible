...
try:
    ...
    from ionos_cloud_sdk.models import KubernetesCluster, KubernetesClusterProperties
...
def main():
    ...
    if not HAS_SDK:
        module.fail_json(
            msg='ionos_cloud_sdk is required for this module, run `pip install ionos_cloud_sdk`')
