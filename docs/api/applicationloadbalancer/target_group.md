...
&nbsp;
  ...
  | :--- | :---: | :--- |
  | name<br /><span style="color:blue">\<str\></span> | True | The target group name. |
  | algorithm<br /><span style="color:blue">\<str\></span> | True | The balancing algorithm. A balancing algorithm consists of predefined rules with the logic that a load balancer uses to distribute network traffic between servers.  - **Round Robin**: Targets are served alternately according to their weighting.  - **Least Connection**: The target with the least active connection is served.  - **Random**: The targets are served based on a consistent pseudorandom algorithm.  - **Source IP**: It is ensured that the same client IP address reaches the same target. |
  | protocol<br /><span style="color:blue">\<str\></span> | True | The forwarding protocol. Only the value 'HTTP' is allowed. |
  | health_check<br /><span style="color:blue">\<dict\></span> | False | Health check properties for target group. |
  | http_health_check<br /><span style="color:blue">\<dict\></span> | False | HTTP health check properties for target group. |
...
&nbsp;
  ...
  | Name | Required | Description |
  | :--- | :---: | :--- |
  | name<br /><span style="color:blue">\<str\></span> | False | The target group name. |
  | target_group<br /><span style="color:blue">\<str\></span> | True | The ID or name of the Target Group. |
  | api_url<br /><span style="color:blue">\<str\></span> | False | The Ionos API base URL. |
  | certificate_fingerprint<br /><span style="color:blue">\<str\></span> | False | The Ionos API certificate fingerprint. |
  | username<br /><span style="color:blue">\<str\></span> | False | The Ionos username. Overrides the IONOS_USERNAME environment variable. |
  | password<br /><span style="color:blue">\<str\></span> | False | The Ionos password. Overrides the IONOS_PASSWORD environment variable. |
...
&nbsp;
  ...
  | :--- | :---: | :--- |
  | name<br /><span style="color:blue">\<str\></span> | False | The target group name. |
  | algorithm<br /><span style="color:blue">\<str\></span> | False | The balancing algorithm. A balancing algorithm consists of predefined rules with the logic that a load balancer uses to distribute network traffic between servers.  - **Round Robin**: Targets are served alternately according to their weighting.  - **Least Connection**: The target with the least active connection is served.  - **Random**: The targets are served based on a consistent pseudorandom algorithm.  - **Source IP**: It is ensured that the same client IP address reaches the same target. |
  | protocol<br /><span style="color:blue">\<str\></span> | False | The forwarding protocol. Only the value 'HTTP' is allowed. |
  | health_check<br /><span style="color:blue">\<dict\></span> | False | Health check properties for target group. |
  | http_health_check<br /><span style="color:blue">\<dict\></span> | False | HTTP health check properties for target group. |
  | targets<br /><span style="color:blue">\<list\></span> | False | Array of items in the collection. |
  | target_group<br /><span style="color:blue">\<str\></span> | True | The ID or name of the Target Group. |
