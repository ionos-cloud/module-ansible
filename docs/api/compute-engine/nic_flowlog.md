...
&nbsp;
  ...
  | server<br /><span style="color:blue">\<str\></span> | True | The ID or name of the Server. |
  | nic<br /><span style="color:blue">\<str\></span> | True | The ID or name of the NIC. |
...
&nbsp;
  ...
  | Name | Required | Description |
  | :--- | :---: | :--- |
  | flowlog<br /><span style="color:blue">\<str\></span> | True | The ID or name of an existing Flowlog. |
  | datacenter<br /><span style="color:blue">\<str\></span> | True | The ID or name of the virtual datacenter. |
  | server<br /><span style="color:blue">\<str\></span> | True | The ID or name of the Server. |
  | nic<br /><span style="color:blue">\<str\></span> | True | The ID or name of the NIC. |
  | api_url<br /><span style="color:blue">\<str\></span> | False | The Ionos API base URL. |
