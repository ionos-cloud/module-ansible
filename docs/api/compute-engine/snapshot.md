...
&nbsp;
  ...
  | :--- | :---: | :--- |
  | datacenter<br /><span style="color:blue">\<str\></span> | True | The datacenter in which the volumes reside. |
  | volume<br /><span style="color:blue">\<str\></span> | True | The name or UUID of the volume. |
  | description<br /><span style="color:blue">\<str\></span> | False | Human-readable description. |
...
&nbsp;
  ...
  | Name | Required | Description |
  | :--- | :---: | :--- |
  | snapshot<br /><span style="color:blue">\<str\></span> | True | The ID or name of an existing snapshot. |
  | api_url<br /><span style="color:blue">\<str\></span> | False | The Ionos API base URL. |
  | certificate_fingerprint<br /><span style="color:blue">\<str\></span> | False | The Ionos API certificate fingerprint. |
  | username<br /><span style="color:blue">\<str\></span> | False | The Ionos username. Overrides the IONOS_USERNAME environment variable. |
  | password<br /><span style="color:blue">\<str\></span> | False | The Ionos password. Overrides the IONOS_PASSWORD environment variable. |
...
&nbsp;
  ...
  | :--- | :---: | :--- |
  | snapshot<br /><span style="color:blue">\<str\></span> | True | The ID or name of an existing snapshot. |
  | licence_type<br /><span style="color:blue">\<str\></span> | False | OS type of this snapshot<br />Options: ['UNKNOWN', 'WINDOWS', 'WINDOWS2016', 'WINDOWS2022', 'RHEL', 'LINUX', 'OTHER'] |
  | cpu_hot_plug<br /><span style="color:blue">\<bool\></span> | False | Hot-plug capable CPU (no reboot required). |
  | cpu_hot_unplug<br /><span style="color:blue">\<bool\></span> | False | Hot-unplug capable CPU (no reboot required). |
  | ram_hot_plug<br /><span style="color:blue">\<bool\></span> | False | Hot-plug capable RAM (no reboot required). |
  | ram_hot_unplug<br /><span style="color:blue">\<bool\></span> | False | Hot-unplug capable RAM (no reboot required). |
  ...
  | disc_scsi_hot_plug<br /><span style="color:blue">\<bool\></span> | False | Hot-plug capable SCSI drive (no reboot required). |
  | disc_scsi_hot_unplug<br /><span style="color:blue">\<bool\></span> | False | Is capable of SCSI drive hot unplug (no reboot required). This works only for non-Windows virtual Machines. |
