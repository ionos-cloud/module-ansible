# mariadb_backup_location_v2_info

This is a simple module that supports listing the Object Storage locations where MariaDB Cluster backups can be stored, using the DBaaS MariaDB v2 API. The region is selected through the I(location) option; set I(api_url) (e.g. C(https://mariadb.de-fra.ionos.com/v2)) to override it directly.
