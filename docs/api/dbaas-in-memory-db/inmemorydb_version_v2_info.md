# inmemorydb_version_v2_info

This is a simple module that supports listing the In-Memory DB versions supported for clusters using the DBaaS In-Memory DB v2 API. The region is selected through the I(location) option; set I(api_url) (e.g. C(https://in-memory-db.de-fra.ionos.com/v2)) to override it directly.
